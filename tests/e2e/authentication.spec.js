...
test.describe('Authentication E2E Tests', () => {
  ...
  test('should signup as manager and auto-login', async ({ page }) => {
    ...
    await signupUser(page, `manager_test_${timestamp}`, `manager_test_${timestamp}@otg.test`, 'password123', 'manager');
  ...
  test('should signup as mentor and auto-login', async ({ page }) => {
    const timestamp = Date.now();
    await signupUser(page, `mentor_test_${timestamp}`, `mentor_test_${timestamp}@otg.test`, 'password123', 'mentor');
